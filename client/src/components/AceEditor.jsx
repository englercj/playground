// Taken from https://github.com/securingsincity/react-ace and made to work with preact.
...
export default class AceEditor extends Component {
    ...
    componentDidMount() {
        ...
        this.editor.setValue(typeof defaultValue === 'undefined' ? value : defaultValue, cursorStart);
